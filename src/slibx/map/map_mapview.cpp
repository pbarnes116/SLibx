...
void MapView::startMovingToLookAt(const LatLon& loc)
{
	...
	getCamera()->startMovingToLookAt(GeoLocation(loc, altitude + 1000));
}
...
LatLon MapView::getLatLonFromTileLocation(const MapTileLocationi& location)
{
	return m_earthRenderer->getLatLonFromTileLocation(location);
}

MapTileLocation MapView::getTileLocationFromLatLon(sl_uint32 level, const LatLon& latLon)
{
	return m_earthRenderer->getTileLocationFromLatLon(level, latLon);
}
...
sl_bool MapView::isShowLayer(sl_uint32 layer)
{
	return m_earthRenderer->isShowLayer(layer);
}

void MapView::setShowLayer(sl_uint32 layer, sl_bool flagShow)
{
	m_earthRenderer->setShowLayer(layer, flagShow);
}

sl_bool MapView::isShowBuilding()
{
	return m_earthRenderer->isShowBuilding();
}

void MapView::setShowBuilding(sl_bool flagShow)
{
	m_earthRenderer->setShowBuilding(flagShow);
}

sl_bool MapView::isShowGISPoi()
{
	return m_earthRenderer->isShowGISPoi();
}

void MapView::setShowGISPoi(sl_bool flagShow)
{
	m_earthRenderer->setShowGISPoi(flagShow);
}

sl_bool MapView::isShowGISLine()
{
	return m_earthRenderer->isShowGISLine();
}

void MapView::setShowGISLine(sl_bool flagShow)
{
	m_earthRenderer->setShowGISLine(flagShow);
}
