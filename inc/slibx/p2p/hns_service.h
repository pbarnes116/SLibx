...
namespace slib
{
	...
	class HnsServiceSession : public Referable
	{
	public:
		String clientId;
		sl_uint64 sessionId;
	...
	class HnsServiceUdpSessionInfo
	{
	public:
		String clientId;
	...
	class HnsService : public Object
	{
	protected:
	...
	public:
		SLIB_PROPERTY(Ptr<IHnsServiceListener>, Listener);
